...
1. Using tools and libraries installed directly on your system.
  ...
  Install Python (2.7.x or 3.7.x), MySQL, and libxml by using system-level package
...
1. The pull request should work for Python 2.7 and 3.7. If you need help writing code that works in both Python 2 and 3, see the documentation at the [Python-Future project](http://python-future.org) (the future package is an Airflow requirement and should be used where possible).
